...
public class MenuCliente extends javax.swing.JFrame {
    ...
    public MenuCliente(String usuario, Sistema s) {
        initComponents();
        this.s = s;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cadastrar pedido", "Cadastrar servico", "Listar meus pedidos", "Cadastrar novo usuario"}));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (i == 0) {
            ContrataServico p = new ContrataServico(s);
            p.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
            p.setVisible(true);
        }
