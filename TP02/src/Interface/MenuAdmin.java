...
public class MenuAdmin extends javax.swing.JFrame {
     ...
     */
    Sistema s;
    public MenuAdmin(String usuario,Sistema s) {
        initComponents();
        this.s = s;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Validar servico", "Cadastrar servico", "Listar pedidos", "Cadastrar novo usuario"}));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(i == 0){
            ValidarServico p = new ValidarServico(s);
            p.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
            p.setVisible(true);
        }
